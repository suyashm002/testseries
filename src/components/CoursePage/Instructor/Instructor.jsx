        ...
        <div key={idx} className='instructor-card'>
            ...
            <div className="instructor-img-stats">
                ...
                <div className="instructor-stats">
                    <p><FontAwesomeIcon icon={("star")} /> {instructor.rating} Instructor Rating</p>
                    <p><FontAwesomeIcon icon={("certificate")} /> {instructor.reviews} Reviews</p>
                    <p><FontAwesomeIcon icon={("user-group")} /> {instructor.students} Students</p>
                    <p><FontAwesomeIcon icon={("circle-play")} /> {instructor.courses} Courses</p>
                </div>
            </div>
