        ...
        <div className="course-cover">
            <div className="cover-items">
                <Breadcrumb className="breadcrumb _path">
                    ...
                    <Breadcrumb.Item linkAs={HashLink} linkProps={{to: '/#course_view'}}>Courses</Breadcrumb.Item>
            ...
            <div className="instructors">
                <span className="instructors_name"><span className="Created_By">Created by</span></span>
            </div>
            ...
            <div className="money-back-cover hidden_items">30-Day</div>
